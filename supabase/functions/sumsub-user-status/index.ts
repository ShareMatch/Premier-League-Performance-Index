...
serve(async (req) => {
  ...
  try {
    ...
    // Get user's KYC status from existing columns
      ...
      try {
        ...
        if (statusResponse.ok) {
          ...
          if (reviewResult) {
            ...
            // User can resubmit unless it's explicitly a FINAL rejection
        ...
        // Continue without rejection details - default to allowing resubmit
