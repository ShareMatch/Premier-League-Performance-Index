  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        {teams.length === 0
          ? // Skeleton Loading for Widget
            [1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex items-center justify-between p-3 rounded-xl bg-gray-800/20 border border-gray-700/30 animate-pulse h-[66px]"
              >
          ...
          : displayTeams.map((team) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    {/* Logo */}
                    <div className="w-10 h-10 flex items-center justify-center group-hover:border-brand-primary/30 transition-colors">
                      {team.logo_url ? (
                        <img
                          src={team.logo_url}
                          alt={team.name}
