    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <button
          ...
          aria-label="Close"
          data-testid="delete-account-modal-close-button"
        >
          <X className="w-6 h-6" />
        </button>
        ...
        >
          ...
          <p className="text-gray-400 font-sans text-sm text-center">
            ...
            portfolio, transaction history, and personal information will be
            permanently deleted.
          </p>
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              data-testid="delete-account-modal-cancel-button"
            >
              Cancel
            </button>
            <button
              ...
              data-testid="delete-account-modal-confirm-delete-button"
            >
