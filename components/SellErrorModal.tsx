...
const SellErrorModal: React.FC<SellErrorModalProps> = ({
  isOpen,
  onClose,
  assetName,
}) => {
  ...
  return (
    <div
      ...
      data-testid="sell-error-modal-overlay"
    >
      {/* Backdrop */}
      <div
        ...
        <div className="p-8 text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              You cannot sell{" "}
              <span className="text-white font-semibold">{assetName}</span>{" "}
              because you do not own this tokenised asset.
            </p>
          </div>
