    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
      ...
      >
        ...
        <button
          ...
          aria-label="Close"
          data-testid="access-denied-modal-close-button"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="p-8 text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              The ShareMatch AI Analytics Engine is a premium utility designed
              exclusively for active market participants.
            </p>
            <p className="text-gray-400 text-xs px-4">
              To access these advanced predictive insights, you must own at
              least one tokenised asset.
            </p>
          </div>
          ...
          <button
            ...
            data-testid="access-denied-modal-explore-button"
          >
