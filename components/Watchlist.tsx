        ...
        return (
          ...
          >
            ...
            <div className="flex-1 flex justify-between items-center min-w-0">
              ...
              <div className="flex items-center gap-[clamp(0.25rem,1.2vw,2rem)] flex-shrink-0 ml-1">
                {/* Price Change Indicator */}
                <div
                  className={`flex items-center gap-0.5 text-[clamp(9px,1vw,10px)] font-bold ${isPositive ? "text-green-400" : "text-red-400"}`}
                >
                  {isPositive ? (
                    <FaCaretUp className="w-2.5 h-2.5 sm:w-3 h-3" />
                  ) : (
                    <FaCaretDown className="w-2.5 h-2.5 sm:w-3 h-3" />
                  )}
